module github.com/xiaozhiliaoo/go-practice

go 1.18

require (
	github.com/avast/retry-go v3.0.0+incompatible
	github.com/bububa/TimeNLP v1.0.3
	...
	// common-golang
	github.com/xiaozhiliaoo/common-golang/common-utils v0.0.0
...
replace github.com/xiaozhiliaoo/common-golang/common-utils => ../common-golang/common-utils
